...
function Intro() {
    return (
        <section className='intro'>
            ...
            <p className="intro__info">Here's how it works: You input some text as a prompt, and the AI model will generate a text completion that attempts to match whatever context or pattern you gave it. For example, if you give the API the prompt, “Write a tagline for an ice cream shop”, it will return a completion like “We serve up smiles with every scoop!” Check out some more <a href='https://beta.openai.com/examples/' target="_blank" rel="noreferrer">examples</a> of what it can do!</p>
